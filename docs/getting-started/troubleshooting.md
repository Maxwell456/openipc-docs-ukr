...
description: "Як прошити або відновити Runcam VRX: запис образу прошивки на SD-картку, покрокове оновлення та відновлення після невдалої прошивки за допомогою RKDevTool."
faq:
  - q: "Як прошити Runcam VRX без комп'ютера?"
    a: "Запишіть образ emmc_flasher на SD-карту, вставте її у VRX, підключіть живлення та один раз нахиліть кнопку «20/40 МГц» на джойстику праворуч. Прошивка запуститься автоматично — дочекайтесь завершення і вийміть карту."
  - q: "Runcam VRX не вмикається після невдалої прошивки. Що робити?"
    a: "Пристрій можна відновити через RKDevTool: затисніть сервісну кнопку біля HDMI-порту, підключіть живлення, з'єднайте VRX із ПК через USB Type-C, додайте в програму loader і образ прошивки та натисніть Run."
  - q: "Який образ прошивки потрібен для відновлення VRX через RKDevTool?"
    a: "Звичайний образ SBC groundstation з GitHub-релізів OpenIPC (НЕ emmc_flasher). Образ emmc_flasher використовується лише для прошивки з SD-карти."
---

# Прошивка та відновлення Runcam VRX
