...
Якщо venc ще не встановлений, дивіться [Встановлення venc на камеру](/software/waybeam-venc-install-camera).
:::
...
- [**Огляд waybeam venc**](/software/waybeam-venc) — всі можливості
