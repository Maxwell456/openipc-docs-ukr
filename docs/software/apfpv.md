...
description: "Прошивка APFPV — найпростіший спосіб передавати FPV-відео через Wi-Fi: дрон стає точкою доступу, а відео дивитесь у PixelPilot. Встановлення через SSH."
faq:
  - q: "Що таке прошивка APFPV?"
    a: "APFPV (Access Point FPV) — прошивка OpenIPC, за якої дрон створює власну Wi-Fi мережу. Ви підключаєтесь до неї з телефона, планшета чи комп'ютера і дивитесь відео в реальному часі без спеціального наземного обладнання."
  - q: "Яка затримка відео в APFPV?"
    a: "Типова затримка — 40–70 мс, за хороших умов до 35 мс. Для перегонів це забагато, але для навчання, польотів круїзом і TinyWhoop — цілком достатньо."
  - q: "Що потрібно для перегляду відео APFPV?"
    a: "Будь-який пристрій з Wi-Fi: Android-смартфон із додатком PixelPilot (рекомендовано), комп'ютер із браузером або будь-який пристрій із підтримкою RTP-потоку."
  - q: "Як встановити APFPV на камеру?"
    a: "Найпростіше — через інтернет: підключіть камеру по Ethernet, зайдіть по SSH (root/12345), виконайте firstboot, а потім sysupgrade з URL прошивки APFPV для вашого SoC. Також можна скористатись OpenIPC Configurator."
---

# Прошивка APFPV — простий FPV через Wi-Fi
...
### Крок 2: Як підключитися до дрона через SSH
...
## Метод 2: Ручне встановлення (без Інтернету)
