...
- [**Встановлення на камеру**](/software/waybeam-venc-install-camera) — завантаження бінарника, конфігурація `/etc/venc.json`, перший запуск
- [**Інтеграція з WFB-ng**](/software/waybeam-venc-install-groundstation) — заміна Majestic на venc у зв'язці з WFB-ng
