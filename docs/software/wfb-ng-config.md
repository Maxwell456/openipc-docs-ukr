...
**Як читати результат:**
- Вказаний бітрейт — це ефективний відеобітрейт після накладання FEC-надлишку
- PHY (radio) — це сирий бітрейт Wi-Fi до FEC
- Для якісного HD-відео потрібно ≥ 15 Мбіт/с; для кінцевого результату — ≥ 20 Мбіт/с
