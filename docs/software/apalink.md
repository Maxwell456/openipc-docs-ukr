...
description: "APALink — перемикання бітрейту для прошивки APFPV: встановлення, налаштування ap_alink.conf, логіка fallback і рекомендовані параметри для стабільного відео."
---

# APALink — динамічна система перемикання бітрейту для APFPV
