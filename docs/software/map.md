...
description: "Інтерактивна карта в системі QuadroFleet (OpenIPC 4G/LTE): запуск вікна карти, інформаційні віджети, робота з точками маршруту та синхронізація з OSD дрона."
---

# Навігація по карті — OpenIPC 4G/LTE
...
Перш ніж продовжити, переконайтеся, що додаток правильно встановлений та налаштований. Якщо налаштування ще не завершено, зверніться до наступного посібника: [Оновлення налаштувань](/software/update-settings)
