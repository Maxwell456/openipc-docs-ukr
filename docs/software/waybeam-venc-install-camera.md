...
Інструкцію звірено з версією **v0.24.1** (липень 2026).
:::
...
**Оновилися зі старої версії?** У v0.21 (IMX415) та v0.23 (IMX335) лінійки режимів сенсорів перероблено, а **індекси `sensor.mode` перенумеровано**. Якщо у старому конфізі був конкретний індекс — звірте його з актуальним списком `/api/v1/modes` або поверніть `-1`.
:::
