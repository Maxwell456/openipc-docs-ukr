...
description: "Оновлення налаштувань камери OpenIPC з прошивкою QuadroFleet: покрокове налаштування камери, параметрів відеопотоку та запуск клієнтського додатку керування."
---

# Оновлення налаштувань OpenIPC з прошивкою QuadroFleet
...
### Крок 2: Налаштування відеопотоку
...
### Крок 3: Запуск додатку керування
