...
description: "OpenIPC Bonnet — плата розширення для Radxa Zero 3W: живлення 2S–6S, USB-хаб, два модулі RTL8812AU, вихід DisplayPort, кнопки GPIO та налаштування RubyFPV."
---

# OpenIPC Bonnet — розширювальна плата для FPV та наземних станцій
...
- **Wi-Fi**: підтримка RTL8812AU (вже є в OpenIPC).
- **IMU**: підключення через I2C, сумісне з програмами для відстеження руху.
- **USB-хаб**: підтримка більшості USB-пристроїв (зокрема адаптери Wi-Fi та флешки).

---


### Призначення кнопок GPIO

5-позиційний джойстик та кнопка запису відображаються на наступні GPIO-піни:
...
### Налаштування RubyFPV

Bonnet сумісний із **RubyFPV**. Для переназначення кнопок створіть файл `gpio.txt` у кореневій директорії microSD-картки та вкажіть відповідні піни.
