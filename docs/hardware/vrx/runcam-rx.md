...
<div style="display: flex; justify-content: center; align-items: flex-start; gap: 2rem; flex-wrap: wrap;">
  <img src="/images/runcam-vrx.webp" alt="головна картинка" width="400px" style="max-width: 100%; height: auto;" />
...
| 💾 Внутрішня пам’ять           | 32 ГБ (включно із системними файлами)                           |
...
<img src="/images/runcam-vrx1.webp" alt="головна картинка" width="600px"/>
