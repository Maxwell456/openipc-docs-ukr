...
| **Аудіо**                 | Мікрофон або лінійний вхід (залежно від версії) |
...
:::
 ...
 Використовуємо інструкцію [прошивки за допомогою  UART](/configuration/uart-flash)  
...
### Як прошити SCC338Q за допомогою файлів прошивки та SCP
