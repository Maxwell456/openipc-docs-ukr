...
description: "OpenFPV — українська документація OpenIPC: відкрита платформа цифрового FPV. Вибір камер і VTX, збірка наземної станції, прошивки, WFB-NG та налаштування."

hero:
  name: " "
  # VPHero рендерить text через v-html: керований перенос (два рівні
  # рядки замість сироти «OpenIPC») + градієнтний акцент на назві
  text: Цифрові FPV-системи<br>на базі <span class="hv2-accent">OpenIPC</span>
...
<section class="hv2-block">
  <h2 class="hv2-eyebrow">З чого почати</h2>
  <div class="hv2-paths">
    <a href="/getting-started/comparison" class="hv2-path">
      <span class="hv2-path-step">01</span>
      <span class="hv2-path-body">
        <span class="hv2-path-title">Обираю систему</span>
        <span class="hv2-path-desc">Чим OpenIPC відрізняється від DJI, Walksnail і HDZero.</span>
      </span>
    ...
    <a href="/hardware/vtx/" class="hv2-path">
      <span class="hv2-path-step">02</span>
      <span class="hv2-path-body">
        <span class="hv2-path-title">Підбираю обладнання</span>
        <span class="hv2-path-desc">Підтримувані камери (VTX), приймачі та мережеві карти.</span>
      </span>
      <svg class="hv2-path-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m9 18 6-6-6-6"/></svg>
    </a>
    <a href="/faq" class="hv2-path">
      <span class="hv2-path-step">03</span>
      <span class="hv2-path-body">
        <span class="hv2-path-title">Щось не працює</span>
        <span class="hv2-path-desc">Немає відео, камера не відповідає, відновлення VRX.</span>
      </span>
      <svg class="hv2-path-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m9 18 6-6-6-6"/></svg>
    </a>
  </div>
...
<!-- ═══ Блок 2: останні оновлення — сигнал, що проєкт живий.
     ...
     3 найновіші пости з docs/updates/posts/ за датою з frontmatter. ═══ -->
<section class="hv2-block">
  <div class="hv2-block-head">
    <h2 class="hv2-eyebrow">Останні оновлення</h2>
    <a class="hv2-updates-all" href="/updates">Всі оновлення →</a>
  </div>
  <LatestUpdates />
</section>
...
/* ── Заголовок hero: щільна типографіка + градієнтний акцент OpenIPC.
     Скоуплено під .VPHome — на doc-сторінки не впливає. ── */
.VPHome .VPHero .text {
...
/* Акцент назви — брендовий синій сайту, без сторонніх кольорів */
.hv2-accent {
...
/* Ссылка «Всі оновлення →» в шапке блока */
.hv2-updates-all {
  font-size: 0.78rem;
  font-weight: 600;
  white-space: nowrap;
