---
title: WebUI для налаштування камери OpenIPC
sidebarTitle: WebUI
date: 2025-04-25
description: "В прошивці Air Unit з'явився WebUI — налаштування камери OpenIPC напряму з браузера: адреса доступу, зміна параметрів відео та збереження конфігурації."
tags:
  - прошивка
  - jumbo
  - webui
...
# WebUI для налаштування камери OpenIPC
