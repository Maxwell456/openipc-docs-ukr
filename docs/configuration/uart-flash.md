...
description: "Універсальний гайд з прошивки камер OpenIPC через UART: підключення FTDI FT232RL, вхід у U-Boot, завантаження uImage і rootfs по TFTP та відновлення цеглинки."
---
# Як відновити абсолютно будь-який Air Unit на OpenIPC?  
**Що вам знадобиться**
