---
title: Оновлення прошивки OpenIPC через sysupgrade
description: Як вручну оновити прошивку камери OpenIPC командою sysupgrade — з релізів GitHub або з локальних файлів uImage і rootfs.
---
