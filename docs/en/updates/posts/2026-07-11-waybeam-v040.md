...
Just a week after [v0.24](/en/updates/posts/2026-07-09-waybeam-v024) — another big leap: on July 11 a squash sync with the developer's fork landed in [OpenIPC/waybeam](https://github.com/OpenIPC/waybeam) — 26 PRs, roughly two months of work. The current version is **v0.40.1**. Below are the highlights of v0.25–v0.40.1 and what to watch out for when upgrading.
